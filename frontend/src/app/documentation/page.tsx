...
export default function DocumentationHomePage() {
  return <DocPage system="Library" eyebrow="HPS system library" title="Documentation with a clear home." summary="The HPS System Library explains the product family, its boundaries, and the relationships between its working applications. Product-specific operating documentation remains with each product.">
